...
$ou="OU=NewUserLanding,DC=LAZERMAN,DC=COM"
$principlename = "@LAZERMAN.com"
$description = "Test Account Generate $date"
$Number_of_users = "5000"
$company = "Lazerman Creations" #We make lizard people
#Supported Nationalities: AU, BR, CA, CH, DE, DK, ES, FI, FR, GB, IE, IR, NL, NZ, TR, US
#Comma separated values for multiple IE:
